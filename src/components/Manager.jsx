    ...
    <>
      ...
      <div className=" p-3 px-40 py-16 mx-auto min-h-[88.2vh] ">
        ...
        <div className="password py-7">
          <h1 className="text-xl text-center pb-4 font-bold text-orange-900 underline">Your Password</h1>
          {passwordArray.length===0 && <div>No password to show</div>}
           {passwordArray.length!=0 && <table className="table-auto w-full bg-violet-300 px-2 m-">
            ...
            <tbody>
              {passwordArray.map((item)=>{
                return  <tr>
                <td className="w-36 text-center flex items-center justify-center">
                  <span>{item.site}</span>
                  <span><Lotiecontroler
            src="/copy.lottie"
            label=""
          ...
          /></span>
                ...
                <td className="w-32 text-center flex items-center justify-center">{item.username}</td>
                <td className="w-32 text-center flex items-center justify-center"><span>{item.password}</span>
                  <span><Lotiecontroler
            src="/copy.lottie"
            label=""
            className="cursor-pointer pt-3 "
